...
public class AddressController {
  ...
  @Operation(summary = "Register address", description = "Registers a new address for the specified user.", responses = {
  ...
  @Operation(summary = "Update address", description = "Updates an existing address. Only the owner of the address can perform this operation.", responses = {
  ...
  @PreAuthorize("@securityAddressService.ownershipCheck(#id)")
  @PutMapping("/{id}")
